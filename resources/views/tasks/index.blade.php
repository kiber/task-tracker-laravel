                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                                @foreach ($tasks as $task)
                                    <tr class="group" data-task-item data-completed="{{ $task['completed_at'] ? 'true' : 'false' }}">
                                        <td class="px-6 py-4">
                                            <button
                                                type="button"
                                        ...
                                        <td class="px-6 py-4">
                                            <p class="text-sm font-medium text-gray-900 dark:text-gray-100 group-data-[completed=true]:line-through">{{ $task['title'] }}</p>
